...
/**
 * Lucide icon geometry, generated from the lucide-static package.
 *
 * Only the inner markup is stored — the <svg> wrapper, its size, stroke and
 * colour are set once by the <x-icon> Blade component, so an icon can never
 * disagree with the rest of the set.
 *
 * Regenerate after changing the icon list; do not hand-edit.
 *
